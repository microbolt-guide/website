...
[patch]: /config/bitcoin/electrum/fulcrum.unix.patch
[config]: /config/bitcoin/electrum/fulcrum.conf
[init.d]: /config/bitcoin/electrum/fulcrum.init.d
[logrotate]: /config/bitcoin/electrum/fulcrum.logrotate
...
```sh copy
$SU apk add jemalloc libzmq python3 qt6-qtbase
```
...
#server {
#  listen 51002 ssl;
#  proxy_pass 127.0.0.1:51001;
#}

# Testnet4
#server {
#  listen 54002 ssl;
#  proxy_pass 127.0.0.1:54001;
#}

# Signet BBO
#server {
#  listen 53002 ssl;
#  proxy_pass 127.0.0.1:53001;
#}
```
...
`testnet4` network, remove the corresponding service `"fulcrum.testnet4"`.
</Callout>
...
$SU ufw limit 51002/tcp comment 'Allow Fulcrum SSL (testnet)'
$SU ufw limit 54002/tcp comment 'Allow Fulcrum SSL (testnet4)'
$SU ufw limit 53002/tcp comment 'Allow Fulcrum SSL (signet BBO)'
```
    </Tabs.Tab>
</Tabs>
</Steps>
...
<Callout>
Check this {name} unix socket [patch] on web browser
</Callout>
...
```sh copy
$SU curl
    -L https://microbolt.guide/config/bitcoin/electrum/fulcrum.banner
...
HiddenServicePort 50002 127.0.0.1:50002 # Mainnet
#HiddenServicePort 51002 127.0.0.1:51002 # Testnet
#HiddenServicePort 54002 127.0.0.1:54002 # Testnet4
#HiddenServicePort 53002 127.0.0.1:53002 # Signet BBO
```
...
hostname and port `50002` for Mainnet or `51002`, `54002`, `53002` for the
others networks.
</FAQBox>
...
```sh copy
$SU ln -s main.conf /etc/fulcrum/testnet4.conf
```

```sh copy
$SU ln -s fulcrum /etc/init.d/fulcrum.testnet4
```

* Create the init configuration file `conf.d/fulcrum.testnet4` and add the
following

```sh copy
$SU $EDITOR /etc/conf.d/fulcrum.testnet4
```

```sh copy filename="/etc/conf.d/fulcrum.testnet4"
FULCRUM_CHAIN=testnet4
FULCRUM_OPTS='--tcp 127.0.0.1:54001
...
```sh copy
$SU rc-update add fulcrum.testnet4 default
```
    </Tabs.Tab>
    <Tabs.Tab>
<Callout>
