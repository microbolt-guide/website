...
export const name = "Nostr Relay"
export const user = "nostr"

[nostr relay written in Rust]: https://sr.ht/~gheartsfield/nostr-rs-relay
[release notes]: https://git.sr.ht/~gheartsfield/nostr-rs-relay/refs
[{name}]: ./nostr_relay

# Nostr Relay

A [nostr relay written in Rust] with support for the entire relay protocol and
data persistence using SQLite.

![Nostr Relay](/images/nostr/nostr-relay.webp)
