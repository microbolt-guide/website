...
export const name = "Umbrel Nostr Relay"
export const user = "umbrel"

[official app]: https://github.com/getumbrel/umbrel-nostr-relay
[nostr-rs-relay]: https://sr.ht/~gheartsfield/nostr-rs-relay
[security section]: ../system/security#reverse-proxy
[release notes]: https://github.com/getumbrel/umbrel-nostr-relay/tags
[{name}]: ./web_app

# Umbrel Nostr Relay

Run your private WebGUI Nostr relay to backup all your activity on Nostr. An
[official app] by {name}. Powered by [nostr-rs-relay].
...
We get the latest release of the {name} source code, compile it to an executable
binary and install it.
...
hidden service on the Microbolt and accessing the {name} with the Tor browser
from any device.
