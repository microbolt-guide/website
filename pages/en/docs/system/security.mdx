...
[UFW Essentials]: https://wiki.alpinelinux.org/wiki/Uncomplicated_Firewall
...
```json copy filename="/etc/awall/private/base.json" /"eth0"/
{
...
{
  "service": {
    "albyhub": { "proto": "tcp", "port": 8030 },
    "btcrpcexpl": { "proto": "tcp", "port": 4000 },
    "dns": [
      { "proto": "tcp", "port": 53 },
      { "proto": "udp", "port": 53 }
    ],
    "electrs": { "proto": "tcp", "port": 50012 },
    "electrs.signet.bbo": { "proto": "tcp", "port": 53012 },
    "electrs.testnet": { "proto": "tcp", "port": 51012 },
    "electrs.testnet4": { "proto": "tcp", "port": 54012 },
    "fulcrum": { "proto": "tcp", "port": 50002 },
    "fulcrum.signet.bbo": { "proto": "tcp", "port": 53002 },
    "fulcrum.testnet": { "proto": "tcp", "port": 51002 },
    "fulcrum.testnet4": { "proto": "tcp", "port": 54002 },
    "lnd-rest": { "proto": "tcp", "port": 8081 },
    "mempool": { "proto": "tcp", "port": 4081 },
    "public-pool": { "proto": "tcp", "port": [ 23333, 4040 ] },
