...
[Lightning]: ./docs/lightning
[Nostr]: ./docs/nostr
[Github Issues]: https://github.com/microbolt-guide/microbolt/issues
[Telegram group]: https://t.me/microbolt_official

# Microbolt

![Microbolt banner image](/images/microbolt-banner.webp)
...
Microbolt is more than a fork of [RaspiBolt] and [MiniBolt], made for all kind
of computers, not only Raspberry Pi's.
...
1. [Bitcoin] : sync your own Bitcoin full node, Electrum server, and Blockchain
Explorer
1. [Lightning] : run your own Lightning client with web-based node management
1. [Nostr] : utilize decentralized and censorship-resistant social networks
