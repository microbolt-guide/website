...
export const app = "ThunderHub"
export const name = "Thunderhub"
export const user = "thunderhub"

[{name}]: https://thunderhub.io
[security section]: ../system/security#reverse-proxy
[release notes]: https://github.com/apotdevin/thunderhub/releases
[Anthony Potdevin]: https://github.com/apotdevin
[telemetry]: https://nextjs.org/telemetry
[Amboss node]: https://amboss.space/es/node/03006fcf3312dae8d068ea297f58e2bd00ec1ffe214b793eda46966b6294a53ce6
[Amboss docs]: https://amboss.tech/docs
[Amboss account]: https://amboss.space/settings?page=account
[{app}]: ./web_app

# ThunderHub

[{name}] is an open source LND node manager where you can manage and monitor
your node on any device or browser. It allows you to take control of the
lightning network with a simple and intuitive UX and the most up-to-date tech
stack.

![ThunderHub homepage](/images/lightning/webapp/thunderhub.webp)
...
[{name}] provides a lightweight and easy to use web interface to accomplish a
great node management.
...
signed by the main developer [Anthony Potdevin].

```sh copy
curl -s https://github.com/apotdevin.gpg | gpg --import
```
...
<Callout type="info">
Keep in mind that if you stop {name}, Amboss will interpret that your node is
offline because the connection is established between {name} \<-> Amboss to send
healthchecks pings
</Callout>
...
with some Lightning Network peers or directly to the [Amboss node]. More info on
[Amboss docs]
</Callout>

* Making sure we are connected to the [Amboss account], now back to {name} for
the next steps
</FAQBox>
...
“Tools” section in {name}, “Backups” -> “Backup all channels” -> “Download”
button.
...
on-chain recovered with seeds, full on-chain re-scan complete, and {name}
installed and running, go to the {name} dashboard.
