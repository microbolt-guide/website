...
We set up the [Lightning Network Daemon] ({name}) by [Lightning Labs].
...
powerful and capable of things not explained here. Check out their [repository]
for a wealth of information about their open-source project and Lightning in
general.
