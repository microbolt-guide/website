...
[installation guide]: https://docs.ansible.com/ansible/latest/installation_guide/installation_distros.html
...
```
    ...
    <Tabs.Tab>
<Callout type="info">
For some Linux distributions, refer to the [installation guide]. Other Unix-like
systems can also check the [installation instructions].
</Callout>
    </Tabs.Tab>
    <Tabs.Tab>
...
[Windows FAQ]. To use Ansible on Windows, consider using WSL. Learn more about
the reasons [here].
</Callout>
    </Tabs.Tab>
</Tabs>
