...
* Instal·leu les eines de compilació necessàries per compilar Fulcrum des del
codi font

```sh copy
$SU apk add clang git lz4-dev make pkgconf qt6-qtbase-dev rocksdb-dev zeromq-dev
```
