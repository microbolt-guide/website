...
* Add the following lines in the "location hidden services" section in the torrc
file
...
start_pre() {
    checkpath --file      --mode 0660 --owner "${FULCRUM_USER}:${FULCRUM_GROUP}" "${FULCRUM_CONFIGFILE}"
    checkpath --directory --mode 0750 --owner "${FULCRUM_USER}:${FULCRUM_GROUP}" "${FULCRUM_DATADIR}"
    checkpath --directory --mode 0755 --owner "${FULCRUM_USER}:${FULCRUM_GROUP}" "${FULCRUM_LOGDIR}"
    checkpath --directory --mode 0755 --owner "${FULCRUM_USER}:${FULCRUM_GROUP}" "${FULCRUM_PIDDIR}"
    checkconfig
}

start_post() {
    checkpath --file --owner "${FULCRUM_USER}:${FULCRUM_GROUP}" "${FULCRUM_PIDFILE}"
}
