...
servidor intermediari invers. Ara podem afegir la configuració del BTC RPC
Explorer.

* Habiliteu el servidor intermediari invers NGINX per afegir xifratge SSL/TLS a
la comunicació del BTC RPC Explorer. Creeu el fitxer de configuració i enganxeu
...
start_stop_daemon_args="--chdir  ${BTCRPCEXPL_DATADIR}
                        --stdout ${BTCRPCEXPL_LOGDIR}/debug.log
...
Torneu a seguir la pàgina [Blockchain explorer](./blockchain-explorer)
