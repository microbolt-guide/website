...
<Tabs items={['caddy', 'nginx']}>
    <Tabs.Tab>
```sh copy
$SU $EDITOR /etc/caddy/btc-rpc-explorer.caddy
```

```caddy copy filename="/etc/caddy/btc-rpc-explorer.caddy"
:4000 {
    reverse_proxy https://127.0.0.1:3002
}
```
