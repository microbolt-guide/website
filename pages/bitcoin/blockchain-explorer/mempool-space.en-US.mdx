...
<Tabs items={['caddy', 'nginx']}>
    <Tabs.Tab>
```sh copy
$SU $EDITOR /etc/caddy/mempool-space.caddy
```

```caddy copy filename="/etc/caddy/mempool-space.caddy"
:4081 {
...
At `2024-08-24` there is at least **8 vulnerabilities** not addressable
...
<Callout type="warning">
At `2024-08-24` there is at least **37 vulnerabilities** not addressable
without breaking changes
...
using your hostname and port `4081`
</FAQBox>
