...
![Pagina principal de Public Pool](/images/bitcoin/mining-pool/publicpool-homepage.webp)
...
Torneu a seguir la pàgina [Pool de Mineria](./mining_pool) substituint el valor
