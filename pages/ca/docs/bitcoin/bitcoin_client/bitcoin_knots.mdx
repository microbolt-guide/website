...
![](/images/bitcoin/client/urinals.gif)
...
<Callout type="info">
La següent comanda demanarà el nom d'usuari i la contrasenya RPC. La contrasenya
serà hashada i emmagatzemada al fitxer `bitcoin.conf`.
Copia i enganxa la següent comanda al teu terminal i prem `Enter`
</Callout>
...
Github](https://github.com/bitcoinknots/bitcoin/releases/latest) del projecte
