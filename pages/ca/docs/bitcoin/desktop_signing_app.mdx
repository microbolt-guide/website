...
![Etapes d'Sparrow](/images/bitcoin/desktop-signing-app/sparrow-stages.webp)
...
![Sparrow connecta a Electrum](/images/bitcoin/desktop-signing-app/sparrow-electrum-no-proxy.webp)
...
![Sparrow es connecta a Electrum a través de Tor](/images/bitcoin/desktop-signing-app/sparrow-electrum-tor-no-proxy.webp)
...
![Ús del servidor intermediari del dimoni Tor](/images/bitcoin/desktop-signing-app/sparrow-tor-proxy.webp)
