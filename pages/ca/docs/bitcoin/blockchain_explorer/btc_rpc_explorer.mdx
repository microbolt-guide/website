...
![Pantalla d'inici de BTC RPC Explorer amb tema fosc](/images/bitcoin/blockchain-explorer/btc-rpc-explorer-homepage.webp)
...
Torneu a seguir la pàgina [BTC RPC Explorer](./btc_rpc_explorer) substituint el
