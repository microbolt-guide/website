...
Bitcoin Core es comunicarà directament amb el 'daemon' Tor per encaminar tot el
trànsit a través de la xarxa Tor. Hem d'habilitar Tor perquè accepti
...
<Callout type="warning">
Primer cal instal·lar [chocolatey](https://chocolatey.org/install)
</Callout>
